...
print(Colors.red + Center.XCenter(Box.DoubleCube("Tool Này Vừa Chạy Vừa Coi Sẽ")))
	...
	while True:
		try:
			...
			if delay > 0:
				...
				os.system('clear')
				print(Colors.red + f"Delay tối thiểu là 1\n")
		except:
			os.system('clear')
			print(Colors.red + f"Vui lòng nhập một số > 0\n")
